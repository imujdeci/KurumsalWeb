...
namespace KurumsalWeb.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Adres,Telefon,Facebook,Twitter,Instagram")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Adres,Telefon,Facebook,Twitter,Instagram")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
